...
@section('title', 'ENEF — Catalogue de formation continue')
...
@section('content')
    ...
    <section class="hero" style="padding:60px 0;">
        <div class="container">
            <div class="eyebrow-line"><span class="rule"></span> Direction de la Formation Continue et du Partenariat</div>
            <h1>Catalogue de formation continue</h1>
            <p class="hero-lede">Année académique 2025-2026 — formations programmées à dates fixes et modules à la
                carte, conçus pour les professionnels de l'environnement et des ressources naturelles.</p>
            <div class="hero-ctas">
