    ...
    <div class="marquee-strip" aria-hidden="true">
        <div class="marquee-track">
            @foreach ($temoignages as $temoignage)
                @php $note = max(0, min(5, (int) $temoignage->note)); @endphp
                <span>
                    {!! str_repeat('★', $note) !!}{!! str_repeat('☆', 5 - $note) !!}
                    <b>« {{ $temoignage->contenu }} »</b>
                    — {{ $temoignage->auteur }}
...
<a href="mailto:infos@enef.gov.bf?subject=Demande%20de%20formation%20%C3%A0%20la%20carte" class="btn btn-primary btn-sm">Faire une demande</a>                </div>
        ...
        <div class="container">
            <div class="section-head">
                <div>
                    ...
                    <h2>Ce qu'en disent nos stagiaires, nos anciens élèves et partenaires</h2>
                </div>
            </div>
            <div class="reviews-grid">
                <div class="review-card">
                    <div class="stars">★★★★★</div>
                    <p>« Une formation très complète en gestion des ressources naturelles, avec des formateurs
                        expérimentés et un vrai suivi terrain. »</p>
                    <div class="review-who">
                        <div class="review-avatar"></div>
                        <div><span class="name">Aïcha K.</span><span class="role">Contrôleur des Eaux et
                                Forêts, promotion 2024</span></div>
                    </div>
                </div>
                <div class="review-card">
                    <div class="stars">★★★★★</div>
                    <p>« Le module SIG et télédétection à la carte a été monté sur mesure pour nos équipes, avec un
                        accompagnement au-delà de la salle de classe. »</p>
                    <div class="review-who">
                        <div class="review-avatar"></div>
                        <div><span class="name">Programme régional</span><span class="role">Partenaire
                                technique</span></div>
                    </div>
                </div>
                <div class="review-card">
                    <div class="stars">★★★★☆</div>
                    <p>« L'appui-conseil de l'ENEF sur notre plan d'aménagement a été rigoureux et bien documenté.
                        Une collaboration à poursuivre. »</p>
                    <div class="review-who">
                        <div class="review-avatar"></div>
                        <div><span class="name">Collectivité territoriale</span><span class="role">Structure
                                bénéficiaire</span></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('styles')
        <style>
            ...
            /*             //-----Style les boutons de filtre (onglets) pour le catalogue ----//
                                                 */
