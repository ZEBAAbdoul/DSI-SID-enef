                    ...
                    <tbody>
                        @forelse ($filieres as $filiere)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.filieres.edit', $filiere) }}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.filieres.destroy', $filiere) }}" method="POST" style="display:inline-block;"
