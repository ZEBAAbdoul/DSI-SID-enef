{{-- resources/views/admin/sessions-formation/index.blade.php --}}
<x-admin>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <form action="{{ route('admin.sessions-formation.index') }}" method="GET" class="form-inline" style="display:inline-block;margin-right:10px;">
                    ...
                    <tbody>
                        @forelse ($sessions as $session)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.sessions-formation.edit', $session) }}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('admin.sessions-formation.destroy', $session) }}" method="POST" style="display:inline-block;"
