...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            <form id="parametresForm" method="POST" action="<?php echo e($parametres ? route('admin.parametres.update', $parametres->id) : route('admin.parametres.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php if($parametres): ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['nom_site'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control <?php $__errorArgs = ['logo_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <?php if($parametres && $parametres->logo_url): ?>
                            <div class="mt-2">
                                <img src="<?php echo e(asset($parametres->logo_url)); ?>" alt="Logo" style="max-height: 80px;" class="border rounded p-1">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control <?php $__errorArgs = ['favicon_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <?php if($parametres && $parametres->favicon_url): ?>
                            <div class="mt-2">
                                <img src="<?php echo e(asset($parametres->favicon_url)); ?>" alt="Favicon" style="max-height: 40px;" class="border rounded p-1">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['mot_dg_titre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control <?php $__errorArgs = ['mot_dg_nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control <?php $__errorArgs = ['mot_dg_contenu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="file" class="form-control <?php $__errorArgs = ['mot_dg_photo_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        <?php if($parametres && $parametres->mot_dg_photo_url): ?>
                            <div class="mt-2">
                                <img src="<?php echo e(asset($parametres->mot_dg_photo_url)); ?>" alt="Photo DG" style="max-height: 100px;" class="border rounded p-1">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control <?php $__errorArgs = ['email_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['annee_creation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control <?php $__errorArgs = ['personne_forme'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <div id="liensUtilesList">
                            <?php $__empty_1 = true; $__currentLoopData = $liensActuels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lien): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <?php $__errorArgs = ['liens_utiles.url.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($parametres && $parametres->updatedBy): ?>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form id="deleteParametresForm" method="POST" action="<?php echo e(route('admin.parametres.destroy', $parametres->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\hp\Desktop\Proje_DGTI\Projet_POSTGRE\DSI-SID-enef\resources\views/admin/parametres/index.blade.php ENDPATH**/ ?>