...
<?php endif; ?>
                    ...
                    <div class="p-2 mt-4">
                        <form method="POST" action="<?php echo e(route('otp.loginWithOtp')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'otp','class' => 'form-control','type' => 'otp','name' => 'otp','value' => old('otp'),'required' => true,'autofocus' => true,'autocomplete' => 'otp']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'otp','class' => 'form-control','type' => 'otp','name' => 'otp','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('otp')),'required' => true,'autofocus' => true,'autocomplete' => 'otp']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>otp <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\Users\HP\Desktop\ENEF\enefApp\resources\views\auth\otp-verification.blade.php ENDPATH**/ ?>