...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Mon dossier de candidature']); ?>
                ...
                <?php if($inscription->statut === 'valide'): ?>
                    ...
                    <div class="validation-banner mb-4" role="status">
                        ...
                        <div class="vb-confetti" aria-hidden="true">
                            <?php for($i = 0; $i < 32; $i++): ?>
                                <i style="--l: <?php echo e(($i * 37 + 11) % 100); ?>%;
                                          --d: <?php echo e(number_format((($i * 7) % 14) / 10, 1)); ?>s;
                                          --c: <?php echo e($couleursConfettis[$i % count($couleursConfettis)]); ?>;
                                          --s: <?php echo e(6 + ($i % 4) * 2); ?>px;
                                          --r: <?php echo e(360 + (($i * 53) % 540)); ?>deg;
                                          --dx: <?php echo e(($i % 2 ? 1 : -1) * (($i * 13) % 70)); ?>px;"></i>
                            <?php endfor; ?>
                        </div>
                            ...
                            <div>
                                ...
                                <?php if($contactRh): ?>
                                    <div class="vb-line vb-d4 mt-3">
                                        <a href="tel:<?php echo e($telRh); ?>" class="btn btn-light vb-call">
                                            <i class="fas fa-phone-alt vb-phone"></i>
                                            <?php echo e($contactRh); ?>
...
<?php endif; ?><?php /**PATH C:\wamp64\www\Les projets finis\ENEF\resources\views/candidat/inscription.blade.php ENDPATH**/ ?>