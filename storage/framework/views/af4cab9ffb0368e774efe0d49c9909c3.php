...
<?php endif; ?>
        ...
        <aside class="main-sidebar sidebar-<?php echo e(Auth::user()->mode); ?>-primary elevation-4">
            ...
            <div class="sidebar">
                <!-- Brand Logo -->
                <a href="<?php echo e(url('/')); ?>" class="brand-link d-flex align-items-center justify-content-center"
                    style="height: 90px;">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <?php if(Auth::user()->avatar != null): ?>
                            <img src="<?php echo e(Auth::user()->avatar); ?>" class="img-circle elevation-2" alt="User Image"
                                width="100" height="100">
                        <?php else: ?>
                            <img src="<?php echo e(asset('admin/dist/img/user.jpg')); ?>" class="img-circle elevation-2"
                                alt="User Image" width="100" height="100">
                        <?php endif; ?>

                    </div>
                    <div class="info">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="d-block text-white"><?php echo e(Auth::user()->name); ?>

                            <?php echo e(Auth::user()->forname); ?></a>
                    </div>
                </div>
                <!-- SidebarSearch Form -->
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>">Acceuil</a></li>
...
<?php /**PATH C:\Users\hp\Desktop\Proje_DGTI\Projet_POSTGRE\DSI-SID-enef\resources\views/components/admin.blade.php ENDPATH**/ ?>