...
<?php $__env->startSection('content'); ?>
    ...
    <section id="actualites" class="alt">
        ...
        <div id="news-batches" hidden>
            <?php $__empty_1 = true; $__currentLoopData = $actualites->chunk(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="news-batch" data-news-batch="<?php echo e($index); ?>">
                    <?php $__currentLoopData = $batch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actualite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo $__env->make('partials.news-card', ['actualite' => $actualite], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section id="bibliotheque" class="alt">
        <div class="container biblio">
            <div>
                ...
                <a href="<?php echo e(route('bibliotheque.index')); ?>" class="btn btn-outline">Accéder aux documents</a>
        ...
        if (retour) {
            retour.addEventListener('click', function () {
                if (window.history.length > 1) {
                    ...
                    window.location.assign('<?php echo e(url('/')); ?>');
                }
            });
        }
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\Desktop\ENEF\enefApp\resources\views/welcome.blade.php ENDPATH**/ ?>