...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <form action="<?php echo e(route('admin.inscription.store')); ?>"
              method="POST"
...
unset($__errorArgs, $__bag); ?>"
                                  rows="4"
                                  maxlength="500"
                                  placeholder="Une précision à ajouter à votre candidature ?"><?php echo e(old('commentaire')); ?></textarea>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $typesPieces; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="form-group piece-upload mb-4">
...
unset($__errorArgs, $__bag); ?>"
                                       id="piece-<?php echo e($type->code); ?>"
                                       name="pieces[<?php echo e($type->code); ?>]"
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               name="confirmation"
                               value="1"
                               <?php echo e(old('confirmation') ? 'checked' : ''); ?>
        ...
        <div class="card shadow-sm sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                ...
                <p class="mb-2">
                    ...
                    <?php
                        $tauxOccupation = $session->places_totales > 0
                            ? round((($session->places_totales - $session->places_disponibles) / $session->places_totales) * 100)
                            : 0;
                    ...
                    <div class="progress mt-2" style="height: 6px;">
                        <div class="progress-bar bg-primary"
                             role="progressbar"
                             style="width: <?php echo e($tauxOccupation); ?>%"
                             aria-valuenow="<?php echo e($tauxOccupation); ?>"
                             aria-valuemin="0"
...
<?php endif; ?><?php /**PATH C:\wamp64\www\Les projets finis\ENEF\resources\views/candidat/inscription-forme.blade.php ENDPATH**/ ?>