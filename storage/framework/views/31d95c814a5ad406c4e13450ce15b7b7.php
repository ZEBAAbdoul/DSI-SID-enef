...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Modifier la matière'); ?>

    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Modifier la matière</h3>
        </div>
        <form action="<?php echo e(route('admin.matieres.update', $matiere)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\HP\Desktop\ENEF\enefApp\resources\views\admin\matieres\edit.blade.php ENDPATH**/ ?>