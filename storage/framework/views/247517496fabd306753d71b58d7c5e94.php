<?php $__env->startSection('title', 'ENEF — Actualités'); ?>
    ...
    <section class="hero" style="padding:24px 0 4px;">
        <div class="container">
            ...
            <div style="margin-bottom:10px;">
                <a href="<?php echo e(url('/')); ?>#actualites" class="btn btn-outline btn-sm">&larr; Retour à l'accueil</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="ri-filter">
                <span class="ri-filter-count">
                    <?php echo e($actualites->total()); ?> actualité(s)
                </span>
            </div>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $actualites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actualite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="ri-card">
                        <a href="<?php echo e(route('actualites.show', $actualite->slug)); ?>"
                           class="ri-thumb"
                           aria-label="Lire « <?php echo e($actualite->titre); ?> »">
                        ...
                        <div class="ri-body">
                            <div class="ri-top">
                                <span class="ri-type"><?php echo e($actualite->type_libelle); ?></span>
                                <span class="ri-date">
                                    <?php echo e($actualite->created_at->translatedFormat('d M Y')); ?>
                            ...
                            <a class="ri-link"
                               href="<?php echo e(route('actualites.show', $actualite->slug)); ?>">Lire la
                                suite
            ...
            <div style="margin-top:32px;">
                <?php echo e($actualites->links('vendor.pagination.enef')); ?>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\Proje_DGTI\Projet_POSTGRE\DSI-SID-enef\resources\views/actualites/index.blade.php ENDPATH**/ ?>