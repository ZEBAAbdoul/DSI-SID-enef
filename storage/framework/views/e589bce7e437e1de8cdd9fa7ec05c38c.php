<?php $__env->startSection('title', 'ENEF — Galerie photo & vidéo'); ?>
    ...
    <section id="galerie" class="alt">
        <div class="container">
            ...
            <div class="gal-tabs" role="tablist" aria-label="Type de médias">
                <button type="button" class="gal-tab <?php echo e($type === 'photos' ? 'active' : ''); ?>"
                        data-panel="galPhotos" role="tab" aria-selected="<?php echo e($type === 'photos' ? 'true' : 'false'); ?>">
                    ...
                    Photos
                    <span class="count"><?php echo e($photos->count()); ?></span>
                </button>
                <button type="button" class="gal-tab <?php echo e($type === 'videos' ? 'active' : ''); ?>"
                        data-panel="galVideos" role="tab" aria-selected="<?php echo e($type === 'videos' ? 'true' : 'false'); ?>">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M23 7l-7 5 7 5V7z" />
                        <rect x="1" y="5" width="15" height="14" rx="2" />
                    </svg>
                    Vidéos
                    <span class="count"><?php echo e($videos->count()); ?></span>
                </button>
            </div>

            
            <div id="galPhotos" class="gal-panel <?php echo e($type === 'photos' ? 'active' : ''); ?>" role="tabpanel">

                <?php if($photos->isNotEmpty()): ?>

                    <div class="gal-carousel" data-carousel="photos">

                        <?php $__currentLoopData = $photoPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="gal-page <?php echo e($pageIndex === 0 ? 'active' : ''); ?>">
                                <?php $__currentLoopData = $page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gal-card" role="button" tabindex="0"
                                         onclick="ouvrirGalerie(<?php echo e($loop->parent->index * 4 + $loop->index); ?>)"
                                         onkeydown="if(event.key==='Enter'||event.key===' '){event.preventDefault();ouvrirGalerie(<?php echo e($loop->parent->index * 4 + $loop->index); ?>);}">
                                        <div class="gal-thumb">
                                            <img src="<?php echo e(asset($photo->image_url)); ?>" alt="<?php echo e($photo->titre); ?>" loading="lazy">
                                        </div>
                                        <div class="gal-body">
                                            <h3><?php echo e($photo->titre); ?></h3>
                                            <?php if($photo->description): ?>
                                                <p><?php echo e(\Illuminate\Support\Str::limit($photo->description, 80)); ?></p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <?php if($photoPages->count() > 1): ?>
                            <div class="gal-pagination">
                                <?php $__currentLoopData = $photoPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageNum => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="gal-pbtn <?php echo e($pageNum === 0 ? 'active' : ''); ?>"
                                            data-page="<?php echo e($pageNum); ?>" aria-label="Page <?php echo e($pageNum + 1); ?>">
            ...
            <div id="galVideos" class="gal-panel <?php echo e($type === 'videos' ? 'active' : ''); ?>" role="tabpanel">

                <?php if($videos->isNotEmpty()): ?>

                    <div class="gal-carousel" data-carousel="videos">

                        <?php $__currentLoopData = $videoPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageIndex => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="gal-page <?php echo e($pageIndex === 0 ? 'active' : ''); ?>">
                                <?php $__currentLoopData = $page; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="gal-vcard">
                                        <div class="gal-vframe">
                                            <div class="gal-vthumb <?php echo e($video->thumbnail_url ? '' : 'no-thumb'); ?>"
                                                 <?php if($video->thumbnail_url): ?>
                                                     style="background-image:url('<?php echo e($video->thumbnail_url); ?>');"
                                                 <?php endif; ?>>
                                                <?php if(!$video->thumbnail_url): ?>
                                                    ...
                                                    <span><?php echo e($video->platform); ?></span>
                                                <?php endif; ?>
                                            </div>

                                            <?php if($video->embed_url): ?>
                                                <button type="button" class="gal-play" aria-label="Lire « <?php echo e($video->titre); ?> »" onclick="jouerVideo(this)">&#9654;</button>
                                                <div class="gal-vembed" aria-hidden="true">
                                                    <iframe data-src="<?php echo e($video->embed_url); ?>" title="<?php echo e($video->titre); ?>"
                                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                                            allowfullscreen tabindex="-1"></iframe>
                                                </div>
                                            <?php else: ?>
                                                <a class="gal-play" href="<?php echo e($video->url); ?>" target="_blank" rel="noopener noreferrer" aria-label="Ouvrir « <?php echo e($video->titre); ?> »">&#9654;</a>
                                            <?php endif; ?>
                                        </div>

                                        <div class="gal-vbody">
                                            <span class="gal-vplatform"><?php echo e($video->platform); ?></span>
                                            <h3><?php echo e($video->titre); ?></h3>
                                            <?php if($video->description): ?>
                                                <p><?php echo e(\Illuminate\Support\Str::limit($video->description, 70)); ?></p>
                                            <?php endif; ?>
                                            <a href="<?php echo e($video->url); ?>" target="_blank" rel="noopener noreferrer" class="gal-vlink">
                                                Ouvrir sur <?php echo e($video->platform); ?>
                        ...
                        <?php if($videoPages->count() > 1): ?>
                            <div class="gal-pagination">
                                <?php $__currentLoopData = $videoPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pageNum => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button type="button" class="gal-pbtn <?php echo e($pageNum === 0 ? 'active' : ''); ?>"
                                            data-page="<?php echo e($pageNum); ?>" aria-label="Page <?php echo e($pageNum + 1); ?>">
                                        <?php echo e($pageNum + 1); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <?php if($photos->isNotEmpty()): ?>
        ...
        ?>
        <script>
            window.galeriePhotos = <?php echo json_encode($galeriePhotos, 15, 512) ?>;
            var galerieIndex = 0;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Desktop\Proje_DGTI\Projet_POSTGRE\DSI-SID-enef\resources\views/galerie/index.blade.php ENDPATH**/ ?>