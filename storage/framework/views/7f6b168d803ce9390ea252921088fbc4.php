...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Candidatures']); ?>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <form action="<?php echo e(route('admin.inscriptions.index')); ?>" method="GET"
                    ...
                    <select name="session_id" class="form-control form-control-sm mr-2 mb-1 mb-md-0"
                        ...
                        <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sessionOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <option value="<?php echo e($sessionOption->id); ?>" <?php if((string) request('session_id') === (string) $sessionOption->id): echo 'selected'; endif; ?>>
                                <?php echo e($sessionOption->formation->titre ?? 'Formation'); ?>

                                — <?php echo e($debut); ?> au <?php echo e($fin); ?>
                    ...
                    <select name="statut" class="form-control form-control-sm mb-1 mb-md-0"
                        ...
                        <option value="depose" <?php if(request('statut') === 'depose'): echo 'selected'; endif; ?>>
                            Déposé
                        </option>

                        <option value="en_cours" <?php if(request('statut') === 'en_cours'): echo 'selected'; endif; ?>>
                            En cours
                        </option>

                        <option value="incomplet" <?php if(request('statut') === 'incomplet'): echo 'selected'; endif; ?>>
                            Incomplet
                        </option>

                        <option value="valide" <?php if(request('statut') === 'valide'): echo 'selected'; endif; ?>>
                            Validé
                        </option>

                        <option value="rejete" <?php if(request('statut') === 'rejete'): echo 'selected'; endif; ?>>
                            Rejeté
                        </option>
                    ...
                    <?php if(request()->filled('session_id') || request()->filled('statut')): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="candidate-name">
                                        ...
                                        <?php echo e($inscription->candidat->name ?? ($inscription->candidat->email ?? 'Candidat inconnu')); ?>
                                ...
                                <td>
                                    ...
                                    <?php if($inscription->session): ?>
                                        <span class="date-session">
                                            ...
                                            au
                                            <?php echo e(\Carbon\Carbon::parse($inscription->session->date_fin)->format('d/m/Y')); ?>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.inscriptions.show', $inscription)); ?>"
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\Les projets finis\ENEF\resources\views/admin/inscriptions/index.blade.php ENDPATH**/ ?>