...
<?php $__env->startSection('title', 'ENEF — Unités pédagogiques et de production'); ?>
    ...
    <section class="hero" style="padding:60px 0;">
        <div class="container">
            ...
            <p class="hero-lede">La formation à l'ENEF repose sur une alternance étroite entre enseignements
                théoriques et travaux pratiques, conduits au sein de <?php echo e(count($unites)); ?> unités pédagogiques et de
            ...
            <div style="margin-top:20px;">
                <a href="<?php echo e(url('/')); ?>#dg" class="btn btn-outline btn-sm">&larr; Retour à l'accueil</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="catalogue-accordion">
                <?php $__currentLoopData = $unites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <details class="module-card" <?php if($loop->first): ?> open <?php endif; ?>>
                        <summary>
                            <span class="module-code">N°<?php echo e($unite['numero']); ?></span>
                            <span class="module-title"><?php echo e($unite['titre']); ?></span>
                            <?php if(!empty($unite['note'])): ?>
                                <span class="badge carte"><?php echo e($unite['note']); ?></span>
                            <?php endif; ?>
                        ...
                        <div class="module-body">
                            <p class="module-resume"><?php echo e($unite['concept']); ?></p>

                            <h5>Objectif général</h5>
                            <p class="module-text"><?php echo e($unite['objectif_general']); ?></p>

                            <?php if(!empty($unite['objectifs_specifiques'])): ?>
                                <h5>Objectifs spécifiques</h5>
                                <ul>
                                    <?php $__currentLoopData = $unite['objectifs_specifiques']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $obj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><?php echo e($obj); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            <?php endif; ?>

                            <?php if(!empty($unite['sous_unites'])): ?>
                                <h5>Sous-unités</h5>
                                <div class="sous-unites-table">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th>Sous-unité</th>
                                                <?php if(collect($unite['sous_unites'])->contains(fn($su) => !empty($su['etat']))): ?>
                                                    <th>État</th>
                                                <?php endif; ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $unite['sous_unites']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $su): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($su['nom']); ?></td>
                                                    <?php if(collect($unite['sous_unites'])->contains(fn($s) => !empty($s['etat']))): ?>
                                                        <td><?php echo e($su['etat'] ?? '—'); ?></td>
                                                    <?php endif; ?>
                                                    <td><?php echo e($su['apps']); ?></td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
...
<?php echo $__env->make('layouts.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Les projets finis\ENEF\resources\views/unites-pedagogiques/index.blade.php ENDPATH**/ ?>